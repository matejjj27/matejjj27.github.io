            ...
            <img src="<?= $row['products_image'] ?>" class="card-img-top" height = "250">
                ...
                <div class="card-footer p-1">
                    <form action="" class="form-submit">
                        ...
                        <a href="./includes/action.php?removeA=<?= $row['products_id'] ?>" 
                                class="text-danger lead" onclick= "return confirm('Are you sure you want to remove this item from your products?')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Delete Product&nbsp;&nbsp;<i class="fas fa-trash-alt"></i></a>
